                              ...
                              @switch($setting['field_type'])
                                ...
                                @case('text')
                                  <div class="input-group input-group-alternative mb-4 @if($errors->has($setting['name'])) has-danger is-invalid-alt @endif">
                                    ...
                                    <input type="text" id="input-{{ $setting['name'] }}" class="form-control form-control-alternative" @if(session('post')) value="{{ session('post.'.$setting['name']) }}" @else value="{{ settings($setting['name']) }}" @endif name="{{ $setting['name'] }}" @if($setting['required'] == true) required="" @endif>
