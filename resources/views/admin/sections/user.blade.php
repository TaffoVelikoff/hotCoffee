  ...
  <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <div class="media align-items-center">
      <span class="avatar avatar-sm rounded-circle">
        <img alt="Image placeholder" src="@if(auth()->user()->attachmentsGroup('avatar')->isEmpty() == true) {{ asset('vendor/hotcoffee/img/admin/unknown.png') }} @else {{ auth()->user()->attachmentsGroup('avatar')->first()->url }} @endif">
      </span>
